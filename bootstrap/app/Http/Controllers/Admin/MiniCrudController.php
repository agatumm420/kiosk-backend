...
/**
 * Class MiniCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class MiniCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Mini::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/mini');
        CRUD::setEntityNameStrings('Mały wygaszacz', 'Małe wygaszacze');
    ...
    {
        CRUD::setValidation(MiniRequest::class);
